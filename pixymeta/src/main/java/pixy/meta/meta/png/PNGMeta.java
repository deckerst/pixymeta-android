...
import pixy.meta.image.png.Chunk;
import pixy.meta.image.png.ChunkType;
import pixy.meta.image.png.ICCPBuilder;
import pixy.meta.image.png.TextBuilder;
import pixy.meta.image.png.TextReader;
import pixy.meta.image.png.UnknownChunk;
...
public class PNGMeta {
    ...
    private static final String ITXT_XMP_KEYWORD = "XML:com.adobe.xmp";
    ...
    private static byte[] readICCProfile(byte[] buf) throws IOException {
        ...
        String profileName = new String(buf, 0, profileName_len, StandardCharsets.UTF_8);
